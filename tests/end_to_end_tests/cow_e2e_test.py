...
def run_test(tested_prog_name, test_case):
    ...
    pipe = Popen([tested_prog_name], stdout = PIPE, stdin = dat_file)
...
if __name__ == "__main__":
    get_files_names(data_files_names, "/my_cow_dat/")
    get_files_names(ans_files_names, "/my_cow_ans/")

    run_test_data("./matrix/mx_lazy")
